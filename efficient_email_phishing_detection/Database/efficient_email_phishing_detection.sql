...
--
-- Host: localhost
-- Generation Time: Jul 27, 2022 at 10:03 AM
...
--
-- Database: `efficient_email_phishing_detection`
--
CREATE DATABASE IF NOT EXISTS `efficient_email_phishing_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `efficient_email_phishing_detection`;
...
(29, 'Naive Bayes', '97.3'),
(30, 'SVM', '97.1'),
(31, 'Logistic Regression', '97.5'),
(32, 'Decision Tree Classifier', '97.0'),
(33, 'KNeighborsClassifier', '92.80000000000001'),
(34, 'SGD Classifier', '97.6'),
(35, 'Random Forest Classifier', '97.1');
...
--
-- Table structure for table `remote_user_email_type_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_email_type_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `EMail_Message` varchar(30000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_email_type_detection`
--

INSERT INTO `remote_user_email_type_detection` (`id`, `EMail_Message`, `Prediction`) VALUES
(1, 'Monica -Huma Abedin <Huma@clintonemail.com>Tuesday June 29 2Non_PhishingPhishingNon_Phishing 6:Non_PhishingPhishing AM''hanleymr@state.gov''; HRe:is already is locked for tonite. I am seeing her right before actually.', 'Non_Phishing'),
(2, 'THIS IS AN OFFICIAL NOTIFICATION OF FUNDS DEPOSITED IN YOUR NAME AND IT IS N=OTA SALES SOLICITATION.I am professor Charles.c. Soludo governor, central bank of Nigeria ( =2Non_PhishingCBN ). Thementioned bank is known for  the safekeeping of special and valuable package=sand baggage in trust for reputable clients that are honest and trustworthy.We work in collaboration with top firms and Governments of various =2Non_Phishingcountries aswe have earned a name as a service whose hallmarks in reliability andconfidentiality are revered. International missions and Embassies of the wor=ldhave used our services to satisfaction.A benefactor whose identity can not be disclosed because of the NonCircumvention and Non Disclosure Agreement that was signed with the saidbenefactor when the funds were being deposited in the Central Bank of Nigeri=a,made you the beneficiary of a package containing some amount of money andstated clearly that you should only be contacted when the time signed =2Non_Phishingfor it tobe in our care elapses and the time has already elapsed that is why you arebeing contacted.The Non Circumvention and Non Disclosure Agreement signed with the benefacto=rmandates us to fully divulge and disclose the benefactor''s identity Phishing8 month=safter you, the beneficiary has received the funds.The funds totals $5.Non_PhishingNon_PhishingNon_Phishing,Non_PhishingNon_PhishingNon_Phishing (Five Million Dollars) i shall reconfirm to youare fully free of any liens, or encumbrances and are clean, clear and non-criminal origin and are available in the form of CASH.You are hereby advised to reconfirm your Full Contact Information forverification with information contained in our computer database as well asother relevant information in the format stated below so that the funds woul=dbe arranged by the deplomats who will be moving the funds from the =2Non_PhishingCentral Bankof Nigeria to be brought to you.I would also inform you clearly here that you must procure an affidavit ofclaim of ownership before the  comensment of the diplomat bringing the =2Non_Phishingfunds toyou, this you will be informed as soon as your information is received.The  Diplomats shall accompany you to your bank (if you want them to) todeposit the funds in your name and submit all documentations of proof of theorigin of the funds in other to exonerate you from any form of investigation=sor interrogation and to authenticate the fact that the funds are clean and h=asno links whatsoever with either drugs or terrorism.The Requested Information is to ensure that no mistake or error is made and =itshould be forwardedin the manner stated below:', 'Phishing'),
(3, 'Dear friend=2CGreetings to you=2EPlease pardon me for contacting you without any formal appointment or communication do consider my status as asylum seeker inDakar Senegal=2EI will like to seek your assistance in receiving and investing the sum of US$4=2E8M held in a holding finance company in europe=2EThe money was deposited by my late father who was killed last year by the rebels during the uprising in Abidjan-Cote d'' Ivoire=2E He was until hissudden death a diamond =2Fcocoa dealer in Angola and Cote d'' Ivoire whichis where he made his wealth=2E Me and my mother arrived Dakar few days ago and confirmed the validity of this deposit then decided to contact you forassistance in view of our present situations=2E We got your contact through the Internet data base while searching for my father''s friends in your country=2EMore details will be given to you as soon as i hear from you=2EPlease includesome of your personal details for us to establish a good business and familyrelationship=2EI look forward to hearing from you Honestly yours=2CMiss=2C Joli Hamed=2E', 'Phishing'),
(4, 'Here is the latest from Lissa Jake and me (I took over from Lissa this morning because her son is winning all his soccermatches somewhere.in Pennsylvania). We still have a bunch of things to add (as you will see in yellow) but this isdefinitely ready for you to engage. I think it will make a real impact and it fits Jim Hoge''s desire not just to make this areport card on the QDDR but to advance some bigger animating ideas.Some questions:I hope this is a read that improves your vacation mood rather than detracting from it!AM', 'Non_Phishing');
