...
ROOT_URLCONF = 'efficient_email_phishing_detection.urls'
...
WSGI_APPLICATION = 'efficient_email_phishing_detection.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'efficient_email_phishing_detection',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
