...
def Prediction_EMail_Phishing_Detection(request):
    if request.method == "POST":
        kword = request.POST.get('keyword')
        if request.method == "POST":
            email_message = request.POST.get('keyword')
        ...
        Email_Type_Detection.objects.create(EMail_Message=email_message,Prediction=val)

        return render(request, 'RUser/Prediction_EMail_Phishing_Detection.html',{'objs': val})
    return render(request, 'RUser/Prediction_EMail_Phishing_Detection.html')
